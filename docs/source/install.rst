...
This will install the package in editable mode i.e. if you change anything in the source code of the package, then you don't need to re-install the package.
